      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"20px" }}>
          ...
          <button className="mobile-only"
            ...
            style={{ background:"none", border:"none", cursor:"none", color:"var(--cream)" }}>
...
export default function CinematographerPortfolio() {
  ...
  useEffect(() => {
    ...
    const targets = document.querySelectorAll("button, a, .portfolio-card, .featured-card, .equip-card, .bts-item");
  ...
  // Reveal on scroll — runs only after sections are mounted (loading=false)
  useReveal(!loading);
